...
public class Client {
    ...
    private static final String STATIONERY_API_URL = "http://localhost:8081/api/v0.1/stationers/";
    private static final String STATIONERY_API_URL_ID = "http://localhost:8081/api/v0.1/stationers/{id}";
